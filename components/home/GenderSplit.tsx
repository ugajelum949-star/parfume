...
type Product = { id: string; name: string; brand: string; price: number; image: string | null; gender: string; stock?: number }

export function GenderSplit({ products, heroForHim, heroForHer }: { products: Product[]; heroForHim?: string | null; heroForHer?: string | null }) {
